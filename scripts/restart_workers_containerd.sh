...
function RestartWorkers() {
    function internal_setup() {
        ...
        CMD=$"cd ~/cluster_manager; git fetch origin;git reset --hard origin/master; sudo /usr/local/go/bin/go run cmd/worker_node/main.go --config cmd/worker_node/config_cluster_containerd.yaml"
