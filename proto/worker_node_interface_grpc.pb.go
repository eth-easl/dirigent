...
func (c *workerNodeInterfaceClient) ReceiveRouteUpdate(ctx context.Context, in *RouteUpdate, opts ...grpc.CallOption) (*ActionStatus, error) {
	out := new(ActionStatus)
	err := c.cc.Invoke(ctx, "/data_plane.WorkerNodeInterface/ReceiveRouteUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerNodeInterfaceClient) PrepullImage(ctx context.Context, in *ImageInfo, opts ...grpc.CallOption) (*ActionStatus, error) {
	out := new(ActionStatus)
	err := c.cc.Invoke(ctx, "/data_plane.WorkerNodeInterface/PrepullImage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkerNodeInterface_ReceiveRouteUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.WorkerNodeInterface/ReceiveRouteUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkerNodeInterface_ListEndpoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.WorkerNodeInterface/ListEndpoints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WorkerNodeInterface_PrepullImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.WorkerNodeInterface/PrepullImage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
