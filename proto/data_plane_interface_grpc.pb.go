...
func (c *dpiInterfaceClient) UpdateDeployment(ctx context.Context, in *ServiceInfo, opts ...grpc.CallOption) (*DeploymentUpdateSuccess, error) {
	out := new(DeploymentUpdateSuccess)
	err := c.cc.Invoke(ctx, "/data_plane.DpiInterface/UpdateDeployment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dpiInterfaceClient) ReceiveRouteUpdate(ctx context.Context, in *RouteUpdate, opts ...grpc.CallOption) (*ActionStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/data_plane.DpiInterface/ReceiveRouteUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dpiInterfaceClient) AddWorkflowDeployment(ctx context.Context, in *WorkflowInfo, opts ...grpc.CallOption) (*DeploymentUpdateSuccess, error) {
	out := new(DeploymentUpdateSuccess)
	err := c.cc.Invoke(ctx, "/data_plane.DpiInterface/AddWorkflowDeployment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dpiInterfaceClient) DeleteWorkflowDeployment(ctx context.Context, in *WorkflowObjectIdentifier, opts ...grpc.CallOption) (*DeploymentUpdateSuccess, error) {
	out := new(DeploymentUpdateSuccess)
	err := c.cc.Invoke(ctx, "/data_plane.DpiInterface/DeleteWorkflowDeployment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DpiInterface_UpdateDeployment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.DpiInterface/UpdateDeployment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DpiInterface_ReceiveRouteUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.DpiInterface/ReceiveRouteUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DpiInterface_AddWorkflowDeployment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.DpiInterface/AddWorkflowDeployment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DpiInterface_DeleteWorkflowDeployment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/data_plane.DpiInterface/DeleteWorkflowDeployment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
