...
func (mr *MockPersistenceLayerMockRecorder) DeleteServiceInformation(ctx, serviceInfo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPersistenceLayerMockRecorder) StoreEndpoint(ctx, endpoint interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
