...
type NodeInfo struct {
	...
	MemorySize int32  `protobuf:"varint,5,opt,name=MemorySize,proto3" json:"MemorySize,omitempty"`
}
...
func (x *NodeInfo) GetMemorySize() int32 {
	if x != nil {
		return x.MemorySize
	}
	return 0
...
var file_control_plane_interface_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x53, 0x69, 0x7a, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52,
