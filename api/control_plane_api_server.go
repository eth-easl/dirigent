...
func CreateNewCpApiServer(client persistence.PersistenceLayer, outputFile string,
	...
	workerNodeCreator core.WorkerNodeFactory, cfg *config2.ControlPlaneConfig) *CpApiServer {

	return &CpApiServer{
		ControlPlane: control_plane.NewControlPlane(client, outputFile, placementPolicy, dataplaneCreator, workerNodeCreator, cfg),
	}
}
